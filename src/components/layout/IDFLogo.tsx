...
export function IDFLogo({ className = 'h-16', language = 'ru' }: IDFLogoProps) {
  ...
  return (
    ...
    >
      {/* Left brand shapes (branding colors retained intentionally) */}
      <g>
      ...
      {/* Text block - uses currentColor so it adapts to the header/login theme */}
      ...
      {/* Invisible padding on the right to prevent clipping at small widths */}
