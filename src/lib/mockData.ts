...
export const mockMessages: ChatMessage[] = [
  ...
  },
  {
    ...
    chatId: 'c_001',
    role: 'assistant',
    content: '**Краткое резюме:** Бизнес-план на Q3 предусматривает увеличение выручки на 15% за счет расширения продуктовой линейки и выхода на новые рынки. Ключевые риски связаны с волатильностью курса валют.\n\n**Чек-лист полноты:**\n✓ Финансовые показатели\n✓ Анализ рынка\n✓ Операционный план\n✗ Детализация рисков (требуется дополнение)\n\n**Рекомендации:**\n1. Усилить раздел управления рисками\n2. Добавить сценарный анализ для валютных колебаний\n3. Конкретизировать KPI по новым продуктам',
    ...
    sources: [
      {
        ...
        type: 'document',
        excerpt: 'Целевой показатель роста выручки составляет 15% по сравнению с предыдущим кварталом...',
        page: 3
      },
      {
        id: 's_002',
        title: 'bizplan_Q3.pdf',
        type: 'document',
        excerpt: 'Основные риски включают валютную волатильность и возможное замедление спроса...',
        page: 12
      }
    ],
    metadata: {
...
export const mockGlossary: GlossaryTerm[] = [
  ...
  {
    id: 'g_003',
    term: 'Финансовая устойчивость',
    definition: 'Способность организации сохранять платежеспособность и эффективно функционировать в долгосрочной перспективе',
    tags: ['финансы', 'аналитика', 'отчетность'],
...
export const mockAuditLogs: AuditLog[] = [
  ...
  {
    id: 'log_003',
    timestamp: '2025-10-01T10:15:22Z',
    userId: 'u_002',
    userEmail: 'admin@apx.kz',
    action: 'user_create',
    resource: 'user_u_004',
    result: 'success',
    traceId: 'tr_i9j0k1l2'
  ...
  {
    id: 'log_004',
    timestamp: '2025-10-01T09:45:10Z',
    userId: 'u_003',
    userEmail: 'ib@apx.kz',
    action: 'login',
  ...
  {
    id: 'log_005',
    timestamp: '2025-09-30T16:20:33Z',
    userId: 'u_001',
    userEmail: 'director@apx.kz',
    action: 'file_upload',
    resource: 'policy_draft.docx',
    result: 'success',
    traceId: 'tr_q7r8s9t0',
    details: { fileSize: 1234567, mimeType: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document' }
  }
];
...
export const mockPrompts: AIPromptTemplate[] = [
  ...
  },
  {
    ...
    template: 'Проведи анализ рисков на основе предоставленных данных, классифицируй по степени критичности и предложи меры митигации',
...
export const mockPolicies: SecurityPolicy[] = [
  ...
  {
    id: 'pol_003',
    name: 'Логирование всех действий',
    description: 'Запись всех действий пользователей в журнал аудита',
    isActive: true,
    type: 'access_control',
